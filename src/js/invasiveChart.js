...
export const InvasiveGraph = function(dataObj, species, initDate, finalDate) {
  ...
  function brushed() {
    ...
    svg
      .select('.zoom')
      .call(zoom.transform, zoomIdentity.scale(chartWidth / (s[1] - s[0])).translate(-s[0], 0));
  }
  ...
  var barColors = [colors['dark-red'], colors['light-purple']];
